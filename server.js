            ...
            $('head').prepend(
                '<script>' +
                    '(function() {' +
                        ...
                        // --- INÍCIO DA FUNCIONALIDADE DE AVANÇAR NO QUIZ (ADICIONADA) ---
                        ...
                        // --- Lógica de Botões Invisíveis (ESSA É A FUNCIONALIDADE DE AVANÇAR NO QUIZ) ---
                        ...
                        '});' +
                        // --- FIM DA FUNCIONALIDADE DE AVANÇAR NO QUIZ (ADICIONADA) ---
                    '})();' +
                '</script>'
            );
